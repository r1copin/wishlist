...
from .views import WishListCreateView, WishDetailView, ReserveWishView, UnreserveWishView
...
urlpatterns = [
    ...
    path('wishes/<int:pk>/unreserve/', UnreserveWishView.as_view(), name='wish-unreserve'),
]
